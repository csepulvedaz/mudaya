...
const yearsArray = () => {
    ...
    while (startYear <= currentYear) {result.push({ value: `${startYear}`, label: `${startYear}` });
        startYear++;}
    return result;
};
...
export const departments = [
    ...
    {value: "Archipiélago de San Andrés, Providencia y Santa Catalina", label: "Archipiélago de San Andrés, Providencia y Santa Catalina"},
];
